...
while True:
    ...
    zone_code = input("give sencor unique Number (type 'exit' to quit): ")
    if zone_code.lower() == "exit":
        break

    # Find all possible paths from zone_code to e1 or e2
    ...
    print("All possible paths from", zone_code, "to e1:")
    ...
    print("\nAll possible paths from", zone_code, "to e2:")
