...
node_colors = ['green' if node in ["e1", "e2"] else 'skyblue' for node in G.nodes()]
# Add a different color for the single node
single_node_index = zone_names.index(zone_code)
node_colors[single_node_index] = 'red'
